...
export const BlogCard = ({ blogData }: any): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <img
        src={
          blogData["cover_image"]
            ? `http://localhost:8000${blogData["cover_image"]}`
            : "/default-cover.jpg"
        }
        alt="cover-image"
            ...
            <img
              src={
                blogData["author_profile_image"]
                  ? `http://localhost:8000${blogData["author_profile_image"]}`
                  : "/default-profile.jpg"
              }
      ...
      {/* Title & subtitle */}
      <h2 className="mt-3 text-lg font-semibold leading-6 text-white cursor-pointer w-full whitespace-nowrap overflow-hidden overflow-ellipsis px-2">
        {blogData.title}
      </h2>
