    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('arts', 'ARTS'), ('games', 'GAMES'), ('healthHEALTH', 'Health'), ('technology', 'TECHNOLOGY'), ('business', 'BUSINESS'), ('sports', 'SPORTS'), ('science', 'SCIENCE')], max_length=20)),
